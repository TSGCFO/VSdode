// src/features/orders/components/ColumnSelector.jsx
...
const ColumnSelector = ({ columns, selectedColumns, onChange, onClose }) => {
  ...
  const handleGroupSelect = (groupColumns, checked) => {
    if (checked) {
      ...
      onChange(remainingColumns.length > 0 ? remainingColumns : ['transaction_id']);
    }
  };
